    ...
    <fieldset>
        ...
        <div class="form-group row">
            <div class="col-md-5">
                ...
                <input id="addharga" type="number" name="addharga" class="form-control" value="{{$barang->harga}}">
            </div>
            <div class="col-md-5">
                <label for="Stok">Stok</label>
                <input id="addstok" type="number" name="addstok" class="form-control" value="{{$barang->stok}}">
            </div>
        </div>
    </fieldset>
    <div class="col-md-10">
        <input type="submit" class="btn btn-success btn-send" value="Ubah Data">
