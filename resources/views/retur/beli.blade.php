...
<form action="{{ route('retur.store') }}" method="POST">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="date" min="1" name="tgl" value="{{ $tgl }}" id="addnmbrg" class="form-control" id="exampleFormControlInput1" required/>
    </div>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input name="kd_brg[]" class="form-control" type="hidden" value="{{$bli->kd_brg}}" readonly>{{$bli->kd_brg}}
                            </td>
                            <td>{{$bli->nm_brg}}</td>
                            <td align="center">
