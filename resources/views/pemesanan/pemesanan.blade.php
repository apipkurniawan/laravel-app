...
<form action="{{ route('detail.store') }}" method="POST">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" name="no_pesan" value="{{ $formatnya }}" class="form-control" id="exampleFormControlInput1" readonly>
    </div>
    <div class="form-group col-sm-4">
        <label for="exampleFormControlInput1">Tanggal Transaksi</label>
        <input type="date" min="1" name="tgl" id="addnmbrg" class="form-control" id="exampleFormControlInput1" value="{{ $tglTrx }}" required >
    </div>
    <div class="form-group col-sm-4">
                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="/transaksi/{{$temp->kd_brg}}" data-confirm-delete="true" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                        ...
                        <tr>
                            <td colspan="3"></td>
                            <td>
                                <input name="total" class="form-control" type="hidden" value="{{$total}}"><a>Total {{ number_format($total) }}</a>
                                <td></td>
                            </td>
                        </tr>
                    </tbody>
